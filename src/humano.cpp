...
Humano::Humano(string _origen, string _tipo, string _id): Propietario(_origen,_tipo)
{
    id=_id;
}
...
string Humano::obtenerid()
{
    return id;
}
void Humano::modificar()
{
    string opcion;
    do
    {
        ...
        {
        case'1':
            cout<<"Introduzca el nuevo planeta de origen del humano (max. 30 caracteres): ";
            cin.ignore(256,'\n');
            getline(cin,origen);
            cout<<endl;
        ...
        case'2':    cout<<"Introduzca el nuevo número de identificación (NNNNNNNNL): "<<endl;
            cin>>id;
            while(ValidaIdHumano(id))
            {
